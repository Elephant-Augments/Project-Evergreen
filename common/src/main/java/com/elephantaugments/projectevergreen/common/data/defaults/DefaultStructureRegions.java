...
public class DefaultStructureRegions {
    ...
    public static final List<String> civilizationDesert = ImmutableList.of(
		...
		"create_ltab:dungeon_desert",
		"create_structures_arise:createdesertwell",
        "custom:npc_spawn_desert",
		"envelope:dovecote_desert",
		...
		"loot_n_explore:desert_inn",
		"mmr:desert_mineshaft",
        "mostructures:sphinx",
    ...
    public static final List<String> civilizationTropical = ImmutableList.of(
		...
		"undergroundworlds:jungle_treehouse",
    ...
    public static final List<String> civilizationSpecialOriental = ImmutableList.of(
		...
		"illagerstructures:monk_tower",
		"illagerstructures:herbalist_house",
    ...
    public static final List<String> wildernessTemperate = ImmutableList.of(
		...
		"archeological:ruined_blue_camp",
		"archeological:ruined_green_camp",
		"archeological:ruined_red_camp",
		...
		"create_ltab:kings_castle",
		"create_ltab:oak_house",
        "create_ltab:the_bunker",
		...
		"illagerstructures:illager_camp",
		"illagerstructures:illager_fort",
		"illagerstructures:illager_stable",
		"illagerstructures:illager_tower",
		"illagerstructures:illager_tower2",
		"illagerstructures:illager_tower3",
		"illagerstructures:lava_extractor",
		"illagerstructures:lone_house",
		"illagerstructures:simple_cart",
		"illagerstructures:simple_well",
		"illagerstructures:smeltery",
		"illagerstructures:totem",
		"illagerstructures:tower_ruin",
		"illagerstructures:well",
        "imst:bandit_camp",
		"jvs:wolf_den",
    ...
    public static final List<String> wildernessFields = ImmutableList.of(
		...
		"archeological:rock_ruins_medium",
		"archeological:rock_ruins_small",
        ...
        "idas:ancient_mines",
        "idas:hermits_hollow",
		"illagerstructures:illager_tipi_camp",
    ...
    public static final List<String> wildernessConiferous = ImmutableList.of(
		...
		"hollowmarch:raid_camp",
        "hunterillager:hunter_house",
        "idas:hunters_cabin",
        "imst:dark_tower",
        "imst:viking_house",
        "illagerinvasion:illusioner_tower",
		"illagerstructures:tipi",
		"jvs:viking_house_grass",
    ...
    public static final List<String> wildernessDeciduous = ImmutableList.of(
        ...
        "betterarcheology:fossil_chicken_birch",
		"butchery:vindicator_butchers_house",
		"create_ltab:dungeon_plains",
    ...
    public static final List<String> wildernessDesert = ImmutableList.of(
		...
		"archeological:desert_ruins_medium",
		"archeological:desert_ruins_small",
        ...
        "goety:buried_ritual",
		"hollowmarch:desert_obelisk",
		"immersiveenchanting:ancient_library_desert",
        "imst:pyramid",
		"jvs:desert_ruins",
    ...
    public static final List<String> wildernessDesertRed = ImmutableList.of(
		...
		"archeological:wasteland_ruins_medium",
		"archeological:wasteland_ruins_small",
        "ba_bt:sandy_land_battle_tower",
    ...
    public static final List<String> wildernessTropical = ImmutableList.of(
		...
		"hollowmarch:jungle_obelisk",
		"hollowmarch:stone_spire",
        "iceandfire:gorgon_temple",
        "illagerinvasion:labyrinth",
		"illagerstructures:mohai_illager",
		"immersiveenchanting:ancient_library_jungle",
        "imst:el_dorado",
		"jvs:jungle_totem",
		"jvs:lush_camp",
    ...
    public static final List<String> wildernessSnow = ImmutableList.of(
		...
		"archeological:frozen_ruins_medium",
		"archeological:frozen_ruins_small",
		...
		"grim_kingdoms:blackridge_watch",
		"grim_kingdoms:chill_hallmanor",
		"grim_kingdoms:decrown_monolith",
		"grim_kingdoms:frostbloom_bastion",
		"grim_kingdoms:frozen_onion_fort",
		"grim_kingdoms:glacierfall_keep",
		"grim_kingdoms:glimmervault_fortress",
		"grim_kingdoms:shardspire_castle",
		"grim_kingdoms:silentgale_citadel",
		"grim_kingdoms:snowgrave_citadel",
		...
		"undergroundworlds:chillager_outpost"
	);
    ...
    public static final List<String> specialCraggy = ImmutableList.of(
		...
		"illagerstructures:balloon_tower",
		"jvs:battle_tower",
        "mostructures:pillager_mines",
    ...
    public static final List<String> specialMagical = ImmutableList.of(
		...
		"create_structures_arise:chocolate_pit",
		"create_structures_arise:honey_pit",
    ...
    public static final List<String> specialShroomy = ImmutableList.of(
		...
		"jvs:illager_mushroom",
		"jvs:mushroom_house",
		"jvs:mushroom_spot",
		"jvs:mushroom_spot_witch",
    ...
    public static final List<String> specialSpooky = ImmutableList.of(
		...
		"qrafty:graveyard",
		"ssp_gothic_things:stonebarracks",
		"ssp_gothic_things:stonechurch",
		"ssp_gothic_things:stonegates",
        "structory:old_manor",
    ...
    public static final List<String> specialSwampy = ImmutableList.of(
		...
		"archeological:ruined_hut_medium",
		"archeological:ruined_hut_small",
		...
		"create_structures_arise:createwitchhut",
    ...
    public static final List<String> allWilderness = ImmutableList.of(
        ...
        "ae2:meteorite",
		"archeological:deep_ruins_large",
		"archeological:deep_ruins_medium",
		"archeological:deep_ruins_small",
        "towns_and_towers:pillager_outpost_badlands",
        "towns_and_towers:pillager_outpost_birch_forest",
        "towns_and_towers:pillager_outpost_desert",
        "towns_and_towers:pillager_outpost_flower_forest",
