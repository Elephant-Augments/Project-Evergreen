...
public class PatchableStructures extends IPatchableData {

    public Map<String, PEStructure> Data;
    ...
    @Override
    protected Map<String, PEStructure> mapPatchableData() {
        Map<String, PEStructure> data = new TreeMap<>();
        defaultSupported.forEach(id -> {
            PEStructure bData = new PEStructure(id);
            data.put(id, bData);
        });
        return data;
    }
    ...
    private static final SortedSet<String> defaultSupported = new TreeSet<>(Arrays.asList(
        ...
        "formationsnether:blackstone_castle",
        "formationsnether:blackstone_remnant",
        "formationsnether:campsite",
        "formationsnether:checkerboard_temple",
        "formationsnether:flaming_pillar",
        "formationsnether:large_house",
        "formationsnether:large_pedestal",
        "formationsnether:large_tree",
        "formationsnether:nether_wart_field",
        "formationsnether:obsidian_pillar",
        "formationsnether:ore_shard",
        "formationsnether:parkour_challenge",
        "formationsnether:quartz_spikes",
        "formationsnether:respawn_anchor_altar",
        "formationsnether:rib_cage",
        "formationsnether:small_fire_arena",
        "formationsnether:small_lava_arena",
        "formationsnether:small_lava_shrine",
        "formationsnether:small_pedestal",
        "formationsnether:sphere_cage",
