...
public class PatchableStructureSets extends IPatchableData {

    public Map<String,  PEStructureSet> Data;
    ...
    @Override
    protected Map<String, PEStructureSet> mapPatchableData() {
        Map<String,  PEStructureSet> data = new TreeMap<>();
        defaultSupported.forEach(id -> {
            PEStructureSet bData = new PEStructureSet(id);
            data.put(id, bData);
        });
        return data;
    }
    ...
    private static final SortedSet<String> defaultSupported = new TreeSet<>(Arrays.asList(
        ...
        "formationsnether:common",
        "formationsnether:ore_shards",
        "formationsnether:rare",
        ...
        "project_evergreen:underground_massive",
