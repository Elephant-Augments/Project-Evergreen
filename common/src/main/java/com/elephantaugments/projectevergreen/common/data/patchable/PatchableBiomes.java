...
public class PatchableBiomes extends IPatchableList {
    ...
    private static final SortedSet<String> defaultSupported = new TreeSet<>(Arrays.asList(
        ...
        "undergroundworlds:spider_cave",
        "undergroundworlds:underground_desert",
        "undergroundworlds:underground_jungle",
        "undergroundworlds:underground_tundra",
