...
public class PatchableBiomes extends IPatchableData {

    public Map<String, PEBiome> Data;
    ...
    public PatchableBiomes() {
        ...
        ProjectEvergreen.LOGGER.info("Here's the first Biome object: " + Data.values().stream().findFirst().get().full_path);
    }

    @Override
    protected Map<String, PEBiome> mapPatchableData() {
        Map<String, PEBiome> data = new TreeMap<>();
        defaultSupported.forEach(id -> {
            PEBiome bData = new PEBiome(id);
            data.put(id, bData);
        });
        return data;
    }

    protected void updateDataKey(String key, PEBiome value) {
