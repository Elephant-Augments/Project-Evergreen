...
public class DefaultStructureBiomes {
    
    public static final String NO_BIOMES = "#project_evergreen:zno_biomes";
    public static final String ALL_OCEAN = "#project_evergreen:has_structures/all_ocean";
    public static final String ALL_RIVERS = "#project_evergreen:has_structures/all_rivers";
    public static final String ALL_CIVILIZATION = "#project_evergreen:has_structures/all_civilization";
    public static final String ALL_WILDERNESS = "#project_evergreen:has_structures/all_wilderness";
    public static final String ALL_UNDERGROUND_LAND = "#project_evergreen:has_structures/all_aunderground_land";
    public static final String CIVILIZATION_TEMPERATE = "#project_evergreen:has_structures/civilization_temperate";
    public static final String CIVILIZATION_FIELDS = "#project_evergreen:has_structures/civilization_fields";
    public static final String CIVILIZATION_CONIFEROUS = "#project_evergreen:has_structures/civilization_coniferous";
    public static final String CIVILIZATION_DECIDUOUS = "#project_evergreen:has_structures/civilization_deciduous";
    public static final String CIVILIZATION_ARID = "#project_evergreen:has_structures/civilization_arid";
    public static final String CIVILIZATION_DESERT = "#project_evergreen:has_structures/civilization_desert";
    public static final String CIVILIZATION_DESERT_RED = "#project_evergreen:has_structures/civilization_desert_red";
    public static final String CIVILIZATION_TROPICAL = "#project_evergreen:has_structures/civilization_tropical";
    public static final String CIVILIZATION_SNOW = "#project_evergreen:has_structures/civilization_snow";
    public static final String CIVILIZATION_SPECIAL_AUTUMNAL = "#project_evergreen:has_structures/civilization_special_autumnal";
    public static final String CIVILIZATION_SPECIAL_COASTAL = "#project_evergreen:has_structures/civilization_special_coastal";
    public static final String CIVILIZATION_SPECIAL_FLOWERY = "#project_evergreen:has_structures/civilization_special_flowery";
    public static final String CIVILIZATION_SPECIAL_ORIENTAL = "#project_evergreen:has_structures/civilization_special_oriental";
    public static final String WILDERNESS_TEMPERATE = "#project_evergreen:has_structures/wilderness_temperate";
    public static final String WILDERNESS_FIELDS = "#project_evergreen:has_structures/wilderness_fields";
    public static final String WILDERNESS_CONIFEROUS = "#project_evergreen:has_structures/wilderness_coniferous";
    public static final String WILDERNESS_DECIDUOUS = "#project_evergreen:has_structures/wilderness_deciduous";
    public static final String WILDERNESS_ARID = "#project_evergreen:has_structures/wilderness_arid";
    public static final String WILDERNESS_DESERT = "#project_evergreen:has_structures/wilderness_desert";
    public static final String WILDERNESS_DESERT_RED = "#project_evergreen:has_structures/wilderness_desert_red";
    public static final String WILDERNESS_TROPICAL = "#project_evergreen:has_structures/wilderness_tropical";
    public static final String WILDERNESS_SNOW = "#project_evergreen:has_structures/wilderness_snow";
    public static final String WILDERNESS_SPECIAL_AUTUMNAL = "#project_evergreen:has_structures/wilderness_special_autumnal";
    public static final String WILDERNESS_SPECIAL_COASTAL = "#project_evergreen:has_structures/wilderness_special_coastal";
    public static final String WILDERNESS_SPECIAL_ORIENTAL = "#project_evergreen:has_structures/wilderness_special_oriental";
    public static final String OCEAN_DEEP = "#project_evergreen:has_structures/all_ocean_deep";
    public static final String OCEAN_SHALLOW = "#project_evergreen:has_structures/all_ocean_shallow";
    public static final String OCEAN_FROZEN = "#project_evergreen:ocean_frozen";
    public static final String OCEAN_DEEP_FROZEN = "#project_evergreen:ocean_deep_frozen";
    public static final String OCEAN_NOT_FROZEN = "#project_evergreen:ocean_not_frozen";
    public static final String OCEAN_WARM = "#project_evergreen:ocean_warm";
    public static final String OCEAN_WARM_DEEP = "#project_evergreen:ocean_deep_lukewarm";
    ...
    public static final String RIVER_OR_COAST_NOT_FROZEN = "#project_evergreen:rivers_or_coasts_not_frozen";
    public static final String RIVER_OR_COAST_FROZEN = "#project_evergreen:rivers_or_coasts_frozen";
    public static final String RIVER_NOT_FROZEN = "#project_evergreen:river_not_frozen";
    ...
    public static final String SPECIAL_BARREN = "#project_evergreen:has_structures/special_barren";
    public static final String SPECIAL_CRAGGY = "#project_evergreen:has_structures/special_craggy";
    public static final String SPECIAL_ICY = "#project_evergreen:has_structures/special_icy";
    public static final String SPECIAL_MAGICAL = "#project_evergreen:has_structures/special_magical";
    public static final String SPECIAL_MEDITERRANEAN = "#project_evergreen:has_structures/special_mediterranean";
    public static final String SPECIAL_MOUNTAINOUS_COLD = "#project_evergreen:has_structures/special_mountainous_cold";
    public static final String SPECIAL_MOUNTAINOUS_HOT = "#project_evergreen:has_structures/special_mountainous_hot";
    public static final String SPECIAL_RUINED = "#project_evergreen:has_structures/special_ruined";
    public static final String SPECIAL_SHROOMY = "#project_evergreen:has_structures/special_shroomy";
    public static final String SPECIAL_SPOOKY = "#project_evergreen:has_structures/special_spooky";
    public static final String SPECIAL_SWAMPY = "#project_evergreen:has_structures/special_swampy";
    public static final String SPECIAL_SWAMPY_WARM = "#project_evergreen:special_swampy_warm";

    public static ArrayListMultimap<String, String> parseDefaultStructureBiomes() {
		ArrayListMultimap<String, String> structuresByBiome = ArrayListMultimap.create();
        allUndergroundLand.forEach(s -> structuresByBiome.put(ALL_UNDERGROUND_LAND, s));
        allCivilization.forEach(s -> structuresByBiome.put(ALL_CIVILIZATION, s));
        allWilderness.forEach(s -> structuresByBiome.put(ALL_WILDERNESS, s));
        allOcean.forEach(s -> structuresByBiome.put(ALL_OCEAN, s));
        allRivers.forEach(s -> structuresByBiome.put(ALL_RIVERS, s));
        civilizationConiferous.forEach(s -> structuresByBiome.put(CIVILIZATION_CONIFEROUS, s));
        civilizationDeciduous.forEach(s -> structuresByBiome.put(CIVILIZATION_DECIDUOUS, s));
        civilizationArid.forEach(s -> structuresByBiome.put(CIVILIZATION_ARID, s));
        civilizationDesert.forEach(s -> structuresByBiome.put(CIVILIZATION_DESERT, s));
        civilizationDesertRed.forEach(s -> structuresByBiome.put(CIVILIZATION_DESERT_RED, s));
        civilizationTropical.forEach(s -> structuresByBiome.put(CIVILIZATION_TROPICAL, s));
        civilizationSnow.forEach(s -> structuresByBiome.put(CIVILIZATION_SNOW, s));
        civilizationFields.forEach(s -> structuresByBiome.put(CIVILIZATION_FIELDS, s));
        civilizationTemperate.forEach(s -> structuresByBiome.put(CIVILIZATION_TEMPERATE, s));
        civilizationSpecialAutumnal.forEach(s -> structuresByBiome.put(CIVILIZATION_SPECIAL_AUTUMNAL, s));
        civilizationSpecialCoastal.forEach(s -> structuresByBiome.put(CIVILIZATION_SPECIAL_COASTAL, s));
        civilizationSpecialOriental.forEach(s -> structuresByBiome.put(CIVILIZATION_SPECIAL_ORIENTAL, s));
        wildernessConiferous.forEach(s -> structuresByBiome.put(WILDERNESS_CONIFEROUS, s));
        wildernessDeciduous.forEach(s -> structuresByBiome.put(WILDERNESS_DECIDUOUS, s));
        wildernessArid.forEach(s -> structuresByBiome.put(WILDERNESS_ARID, s));
        wildernessDesert.forEach(s -> structuresByBiome.put(WILDERNESS_DESERT, s));
        wildernessDesertRed.forEach(s -> structuresByBiome.put(WILDERNESS_DESERT_RED, s));
        wildernessTropical.forEach(s -> structuresByBiome.put(WILDERNESS_TROPICAL, s));
        wildernessSnow.forEach(s -> structuresByBiome.put(WILDERNESS_SNOW, s));
        wildernessFields.forEach(s -> structuresByBiome.put(WILDERNESS_FIELDS, s));
        wildernessTemperate.forEach(s -> structuresByBiome.put(WILDERNESS_TEMPERATE, s));
        wildernessSpecialAutumnal.forEach(s -> structuresByBiome.put(WILDERNESS_SPECIAL_AUTUMNAL, s));
        wildernessSpecialCoastal.forEach(s -> structuresByBiome.put(WILDERNESS_SPECIAL_COASTAL, s));
        wildernessSpecialOriental.forEach(s -> structuresByBiome.put(WILDERNESS_SPECIAL_ORIENTAL, s));
        specialBarren.forEach(s -> structuresByBiome.put(SPECIAL_BARREN, s));
        specialCraggy.forEach(s -> structuresByBiome.put(SPECIAL_CRAGGY, s));
        civilizationSpecialFlowery.forEach(s -> structuresByBiome.put(CIVILIZATION_SPECIAL_FLOWERY, s));
        specialIcy.forEach(s -> structuresByBiome.put(SPECIAL_ICY, s));
        specialMagical.forEach(s -> structuresByBiome.put(SPECIAL_MAGICAL, s));
        specialMediterranean.forEach(s -> structuresByBiome.put(SPECIAL_MEDITERRANEAN, s));
        specialMountainousCold.forEach(s -> structuresByBiome.put(SPECIAL_MOUNTAINOUS_COLD, s));
        specialMountainousHot.forEach(s -> structuresByBiome.put(SPECIAL_MOUNTAINOUS_HOT, s));
        specialRuined.forEach(s -> structuresByBiome.put(SPECIAL_RUINED, s));
        specialShroomy.forEach(s -> structuresByBiome.put(SPECIAL_SHROOMY, s));
        specialSpooky.forEach(s -> structuresByBiome.put(SPECIAL_SPOOKY, s));
        specialSwampy.forEach(s -> structuresByBiome.put(SPECIAL_SWAMPY, s));
        specialSwampyWarm.forEach(s -> structuresByBiome.put(SPECIAL_SWAMPY_WARM, s));
        oceanRareDeep.forEach(s -> structuresByBiome.put(OCEAN_RARE_DEEP, s));
        oceanRareShallow.forEach(s -> structuresByBiome.put(OCEAN_RARE_SHALLOW, s));
        oceanWarm.forEach(s -> structuresByBiome.put(OCEAN_WARM, s));
        oceanWarmDeep.forEach(s -> structuresByBiome.put(OCEAN_WARM_DEEP, s));
        oceanDeep.forEach(s -> structuresByBiome.put(OCEAN_DEEP, s));
        oceanShallow.forEach(s -> structuresByBiome.put(OCEAN_SHALLOW, s));
        oceanFrozen.forEach(s -> structuresByBiome.put(OCEAN_FROZEN, s));
        oceanDeepFrozen.forEach(s -> structuresByBiome.put(OCEAN_DEEP_FROZEN, s));
        oceanNotFrozen.forEach(s -> structuresByBiome.put(OCEAN_NOT_FROZEN, s));
        riverOrCoastNotFrozen.forEach(s -> structuresByBiome.put(RIVER_OR_COAST_NOT_FROZEN, s));
        riverOrCoastFrozen.forEach(s -> structuresByBiome.put(RIVER_OR_COAST_FROZEN, s));
        riverFrozen.forEach(s -> structuresByBiome.put(RIVER_FROZEN, s));
        riverNotFrozen.forEach(s -> structuresByBiome.put(RIVER_NOT_FROZEN, s));
        riverTemperate.forEach(s -> structuresByBiome.put(RIVER_TEMPERATE, s));
        riverWarm.forEach(s -> structuresByBiome.put(RIVER_WARM, s));
