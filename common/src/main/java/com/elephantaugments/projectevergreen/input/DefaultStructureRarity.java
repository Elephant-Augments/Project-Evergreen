...
public class DefaultStructureRarity {
    ...
    public static final String UNDERGROUND_MASSIVE = "project_evergreen:underground_massive";
    public static final String SKY_MASSIVE = "project_evergreen:sky_massive";
    
    @SuppressWarnings("null")
    public static ArrayListMultimap<String, String> parseDefaultStructureRarities() {
		ArrayListMultimap<String, String> structuresByRarity = ArrayListMultimap.create();
        civilizationMassive.forEach(s -> structuresByRarity.put(CIVILIZATION_MASSIVE, s));
        civilizationMedium.forEach(s -> structuresByRarity.put(CIVILIZATION_MEDIUM, s));
        civilizationDeco.forEach(s -> structuresByRarity.put(CIVILIZATION_DECO, s));
        wildernessMassive.forEach(s -> structuresByRarity.put(WILDERNESS_MASSIVE, s));
        wildernessMedium.forEach(s -> structuresByRarity.put(WILDERNESS_MEDIUM, s));
        wildernessDeco.forEach(s -> structuresByRarity.put(WILDERNESS_DECO, s));
        oceanFloatingMassive.forEach(s -> structuresByRarity.put(OCEAN_FLOATING_MASSIVE, s));
        oceanUnderwaterMassive.forEach(s -> structuresByRarity.put(OCEAN_UNDERWATER_MASSIVE, s));
        oceanAllMedium.forEach(s -> structuresByRarity.put(OCEAN_ALL_MEDIUM, s));
        undergroundMassive.forEach(s -> structuresByRarity.put(UNDERGROUND_MASSIVE, s));
        skyMassive.forEach(s -> structuresByRarity.put(SKY_MASSIVE, s));
    ...
    //UNDERGROUND_MASSIVE
    public static final List<String> undergroundMassive = ImmutableList.of(
