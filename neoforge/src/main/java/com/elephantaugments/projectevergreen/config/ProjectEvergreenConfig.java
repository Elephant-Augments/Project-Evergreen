package com.elephantaugments.projectevergreen.config;

import com.elephantaugments.projectevergreen.ProjectEvergreen;
import com.elephantaugments.projectevergreen.ProjectEvergreenNeoforge;
...
public class ProjectEvergreenConfig {
    ...
    private static ModConfigSpec.ConfigValue<String> LOST_CITIES_BIOME;
    private static ModConfigSpec.ConfigValue<String> LOST_CITIES_LIQUID;
    ...
    static void onLoad(final ModConfigEvent event)
    {
        ...
        ignoreMod = getConfigList(Blacklist.modIDs, IGNORE_MOD.get());
        ignoreStructure = getConfigList(Blacklist.structureIDs, IGNORE_STRUCTURE.get());
        ignoreStructureType = getConfigList(Blacklist.ignoreStructureType, IGNORE_STRUCTURE_TYPE.get());
        ignoreBiomeRedistribution = getConfigList(Blacklist.ignoreBiomeRedistribution, IGNORE_BIOME_REDISTRIBUTION.get());
        ignoreFlatnessCheck = getConfigList(Blacklist.ignoreFlatnessCheck, IGNORE_FLATNESS_CHECK.get());
        ...
        undergroundMassive = getConfigList(DefaultStructureRarity.undergroundMassive, UNDERGROUND_MASSIVE.get());
        ...
        allCivilization = getConfigList(DefaultStructureBiomes.allCivilization, ALL_CIVILIZATION.get());
        allWilderness = getConfigList(DefaultStructureBiomes.allWilderness, ALL_WILDERNESS.get());
        allOcean = getConfigList(DefaultStructureBiomes.allOcean, ALL_OCEAN.get());
        allRivers = getConfigList(DefaultStructureBiomes.allRivers, ALL_RIVERS.get());
        civilizationConiferous = getConfigList(DefaultStructureBiomes.civilizationConiferous, CIVILIZATION_CONIFEROUS.get());
        civilizationDeciduous = getConfigList(DefaultStructureBiomes.civilizationDeciduous, CIVILIZATION_DECIDUOUS.get());
        civilizationArid = getConfigList(DefaultStructureBiomes.civilizationArid, CIVILIZATION_ARID.get());
        civilizationDesert = getConfigList(DefaultStructureBiomes.civilizationDesert, CIVILIZATION_DESERT.get());
        civilizationDesertRed = getConfigList(DefaultStructureBiomes.civilizationDesertRed, CIVILIZATION_DESERT_RED.get());
        civilizationTropical = getConfigList(DefaultStructureBiomes.civilizationTropical, CIVILIZATION_TROPICAL.get());
        civilizationSnow = getConfigList(DefaultStructureBiomes.civilizationSnow, CIVILIZATION_SNOW.get());
        civilizationFields = getConfigList(DefaultStructureBiomes.civilizationFields, CIVILIZATION_FIELDS.get());
        civilizationTemperate = getConfigList(DefaultStructureBiomes.civilizationTemperate, CIVILIZATION_TEMPERATE.get());
        civilizationSpecialAutumnal = getConfigList(DefaultStructureBiomes.civilizationSpecialAutumnal, CIVILIZATION_SPECIAL_AUTUMNAL.get());
        civilizationSpecialCoastal = getConfigList(DefaultStructureBiomes.civilizationSpecialCoastal, CIVILIZATION_SPECIAL_COASTAL.get());
        civilizationSpecialFlowery = getConfigList(DefaultStructureBiomes.civilizationSpecialFlowery, CIVILIZATION_SPECIAL_FLOWERY.get());
        civilizationSpecialOriental = getConfigList(DefaultStructureBiomes.civilizationSpecialOriental, CIVILIZATION_SPECIAL_ORIENTAL.get());
        wildernessConiferous = getConfigList(DefaultStructureBiomes.wildernessConiferous, WILDERNESS_CONIFEROUS.get());
        wildernessDeciduous = getConfigList(DefaultStructureBiomes.wildernessDeciduous, WILDERNESS_DECIDUOUS.get());
        wildernessArid = getConfigList(DefaultStructureBiomes.wildernessArid, WILDERNESS_ARID.get());
        wildernessDesert = getConfigList(DefaultStructureBiomes.wildernessDesert, WILDERNESS_DESERT.get());
        wildernessDesertRed = getConfigList(DefaultStructureBiomes.wildernessDesertRed, WILDERNESS_DESERT_RED.get());
        wildernessTropical = getConfigList(DefaultStructureBiomes.wildernessTropical, WILDERNESS_TROPICAL.get());
        wildernessSnow = getConfigList(DefaultStructureBiomes.wildernessSnow, WILDERNESS_SNOW.get());
        wildernessFields = getConfigList(DefaultStructureBiomes.wildernessFields, WILDERNESS_FIELDS.get());
        wildernessTemperate = getConfigList(DefaultStructureBiomes.wildernessTemperate, WILDERNESS_TEMPERATE.get());
        wildernessSpecialAutumnal = getConfigList(DefaultStructureBiomes.wildernessSpecialAutumnal, WILDERNESS_SPECIAL_AUTUMNAL.get());
        wildernessSpecialCoastal = getConfigList(DefaultStructureBiomes.wildernessSpecialCoastal, WILDERNESS_SPECIAL_COASTAL.get());
        wildernessSpecialOriental = getConfigList(DefaultStructureBiomes.wildernessSpecialOriental, WILDERNESS_SPECIAL_ORIENTAL.get());
        specialBarren = getConfigList(DefaultStructureBiomes.specialBarren, SPECIAL_BARREN.get());
        specialCraggy = getConfigList(DefaultStructureBiomes.specialCraggy, SPECIAL_CRAGGY.get());
        specialIcy = getConfigList(DefaultStructureBiomes.specialIcy, SPECIAL_ICY.get());
        specialMagical = getConfigList(DefaultStructureBiomes.specialMagical, SPECIAL_MAGICAL.get());
        specialMediterranean = getConfigList(DefaultStructureBiomes.specialMediterranean, SPECIAL_MEDITERRANEAN.get());
        specialMountainousCold = getConfigList(DefaultStructureBiomes.specialMountainousCold, SPECIAL_MOUNTAINOUS_COLD.get());
        specialMountainousHot = getConfigList(DefaultStructureBiomes.specialMountainousHot, SPECIAL_MOUNTAINOUS_HOT.get());
        specialRuined = getConfigList(DefaultStructureBiomes.specialRuined, SPECIAL_RUINED.get());
        specialShroomy = getConfigList(DefaultStructureBiomes.specialShroomy, SPECIAL_SHROOMY.get());
        specialSpooky = getConfigList(DefaultStructureBiomes.specialSpooky, SPECIAL_SPOOKY.get());
        specialSwampy = getConfigList(DefaultStructureBiomes.specialSwampy, SPECIAL_SWAMPY.get());
        specialSwampyWarm = getConfigList(DefaultStructureBiomes.specialSwampyWarm, SPECIAL_SWAMPY_WARM.get());
        oceanRareDeep = getConfigList(DefaultStructureBiomes.oceanRareDeep, OCEAN_RARE_DEEP.get());
        oceanRareShallow = getConfigList(DefaultStructureBiomes.oceanRareShallow, OCEAN_RARE_SHALLOW.get());
        oceanWarm = getConfigList(DefaultStructureBiomes.oceanWarm, OCEAN_WARM.get());
        oceanWarmDeep = getConfigList(DefaultStructureBiomes.oceanWarmDeep, OCEAN_WARM_DEEP.get());
        oceanDeep = getConfigList(DefaultStructureBiomes.oceanDeep, OCEAN_DEEP.get());
        oceanShallow = getConfigList(DefaultStructureBiomes.oceanShallow, OCEAN_SHALLOW.get());
        oceanFrozen = getConfigList(DefaultStructureBiomes.oceanFrozen, OCEAN_FROZEN.get());
        oceanDeepFrozen = getConfigList(DefaultStructureBiomes.oceanDeepFrozen, OCEAN_DEEP_FROZEN.get());
        oceanNotFrozen = getConfigList(DefaultStructureBiomes.oceanNotFrozen, OCEAN_NOT_FROZEN.get());
        riverOrCoastNotFrozen = getConfigList(DefaultStructureBiomes.riverOrCoastNotFrozen, RIVER_OR_COAST_NOT_FROZEN.get());
        riverOrCoastFrozen = getConfigList(DefaultStructureBiomes.riverOrCoastFrozen, RIVER_OR_COAST_FROZEN.get());
        riverFrozen = getConfigList(DefaultStructureBiomes.riverFrozen, RIVER_FROZEN.get());
        riverNotFrozen = getConfigList(DefaultStructureBiomes.riverNotFrozen, RIVER_NOT_FROZEN.get());
        riverTemperate = getConfigList(DefaultStructureBiomes.riverTemperate, RIVER_TEMPERATE.get());
        riverWarm = getConfigList(DefaultStructureBiomes.riverWarm, RIVER_WARM.get());
        undergroundLand = getConfigList(DefaultStructureBiomes.allUndergroundLand, UNDERGROUND_LAND.get());
    ...
    static {
        ...
        LOST_CITIES_BIOME = COMMON_BUILDER
            ...
            .define(Constants.LOST_CITIES_BIOME, Constants.DEFAULT_LOST_CITIES_BIOME);
        LOST_CITIES_LIQUID = COMMON_BUILDER
            .comment("# The ID of the liquid generated in oceans/lakes within the Lost Cities dimension.")
            .define(Constants.LOST_CITIES_LIQUID, Constants.DEFAULT_LOST_CITIES_LIQUID);
        ...
        IGNORE_MOD = COMMON_BUILDER
            ...
            .defineListAllowEmpty(Blacklist.IGNORE_MOD, EMPTY_LIST, () -> "", ProjectEvergreenConfig::validateListItem);
        IGNORE_STRUCTURE = COMMON_BUILDER
            ...
            .defineListAllowEmpty(Blacklist.IGNORE_STRUCTURE, EMPTY_LIST, () -> "", ProjectEvergreenConfig::validateListItem);
        IGNORE_BIOME_REDISTRIBUTION = COMMON_BUILDER
            .comment("# Allows structures to spawn via their original modded biome parameters.")
            .defineListAllowEmpty(Blacklist.IGNORE_BIOME_REDISTRIBUTION, EMPTY_LIST, () -> "", ProjectEvergreenConfig::validateListItem);
        IGNORE_STRUCTURE_TYPE = COMMON_BUILDER
            ...
            .defineListAllowEmpty(Blacklist.IGNORE_STRUCTURE_TYPE, EMPTY_LIST, () -> "", ProjectEvergreenConfig::validateListItem);
        IGNORE_FLATNESS_CHECK = COMMON_BUILDER
            ...
            .defineListAllowEmpty(Blacklist.IGNORE_FLATNESS_CHECK, EMPTY_LIST, () -> "", ProjectEvergreenConfig::validateListItem);
        ...
        ALLOWED_TERRAIN_HEIGHT_NARROW = COMMON_BUILDER
            ...
            .defineInRange(Constants.ALLOWED_TERRAIN_HEIGHT_NARROW, 18, 6, 30);
        ...
        ALLOWED_TERRAIN_HEIGHT_WIDE = COMMON_BUILDER
            .comment("# The average elevation (in blocks) at which flat_wide structures can be allowed to spawn.\n# (10 = extremely flat, 40 = vanilla parity)")
            .defineInRange(Constants.ALLOWED_TERRAIN_HEIGHT_WIDE, 26, 10, 40);
    ...
    public static ArrayListMultimap<String, String> parseStructureBiomes() {
        ...
        allCivilization.forEach(s -> structuresByBiome.put(DefaultStructureBiomes.ALL_CIVILIZATION, s));
        allWilderness.forEach(s -> structuresByBiome.put(DefaultStructureBiomes.ALL_WILDERNESS, s));
        allOcean.forEach(s -> structuresByBiome.put(DefaultStructureBiomes.ALL_OCEAN, s));
        allRivers.forEach(s -> structuresByBiome.put(DefaultStructureBiomes.ALL_RIVERS, s));
        civilizationConiferous.forEach(s -> structuresByBiome.put(DefaultStructureBiomes.CIVILIZATION_CONIFEROUS, s));
        civilizationDeciduous.forEach(s -> structuresByBiome.put(DefaultStructureBiomes.CIVILIZATION_DECIDUOUS, s));
        civilizationArid.forEach(s -> structuresByBiome.put(DefaultStructureBiomes.CIVILIZATION_ARID, s));
        civilizationDesert.forEach(s -> structuresByBiome.put(DefaultStructureBiomes.CIVILIZATION_DESERT, s));
        civilizationDesertRed.forEach(s -> structuresByBiome.put(DefaultStructureBiomes.CIVILIZATION_DESERT_RED, s));
        civilizationTropical.forEach(s -> structuresByBiome.put(DefaultStructureBiomes.CIVILIZATION_TROPICAL, s));
        civilizationSnow.forEach(s -> structuresByBiome.put(DefaultStructureBiomes.CIVILIZATION_SNOW, s));
        civilizationFields.forEach(s -> structuresByBiome.put(DefaultStructureBiomes.CIVILIZATION_FIELDS, s));
        civilizationTemperate.forEach(s -> structuresByBiome.put(DefaultStructureBiomes.CIVILIZATION_TEMPERATE, s));
        civilizationSpecialAutumnal.forEach(s -> structuresByBiome.put(DefaultStructureBiomes.CIVILIZATION_SPECIAL_AUTUMNAL, s));
        civilizationSpecialCoastal.forEach(s -> structuresByBiome.put(DefaultStructureBiomes.CIVILIZATION_SPECIAL_COASTAL, s));
        civilizationSpecialOriental.forEach(s -> structuresByBiome.put(DefaultStructureBiomes.CIVILIZATION_SPECIAL_ORIENTAL, s));
        wildernessConiferous.forEach(s -> structuresByBiome.put(DefaultStructureBiomes.WILDERNESS_CONIFEROUS, s));
        wildernessDeciduous.forEach(s -> structuresByBiome.put(DefaultStructureBiomes.WILDERNESS_DECIDUOUS, s));
        wildernessArid.forEach(s -> structuresByBiome.put(DefaultStructureBiomes.WILDERNESS_ARID, s));
        wildernessDesert.forEach(s -> structuresByBiome.put(DefaultStructureBiomes.WILDERNESS_DESERT, s));
        wildernessDesertRed.forEach(s -> structuresByBiome.put(DefaultStructureBiomes.WILDERNESS_DESERT_RED, s));
        wildernessTropical.forEach(s -> structuresByBiome.put(DefaultStructureBiomes.WILDERNESS_TROPICAL, s));
        wildernessSnow.forEach(s -> structuresByBiome.put(DefaultStructureBiomes.WILDERNESS_SNOW, s));
        wildernessFields.forEach(s -> structuresByBiome.put(DefaultStructureBiomes.WILDERNESS_FIELDS, s));
        wildernessTemperate.forEach(s -> structuresByBiome.put(DefaultStructureBiomes.WILDERNESS_TEMPERATE, s));
        wildernessSpecialAutumnal.forEach(s -> structuresByBiome.put(DefaultStructureBiomes.WILDERNESS_SPECIAL_AUTUMNAL, s));
        wildernessSpecialCoastal.forEach(s -> structuresByBiome.put(DefaultStructureBiomes.WILDERNESS_SPECIAL_COASTAL, s));
        wildernessSpecialOriental.forEach(s -> structuresByBiome.put(DefaultStructureBiomes.WILDERNESS_SPECIAL_ORIENTAL, s));
        specialBarren.forEach(s -> structuresByBiome.put(DefaultStructureBiomes.SPECIAL_BARREN, s));
        specialCraggy.forEach(s -> structuresByBiome.put(DefaultStructureBiomes.SPECIAL_CRAGGY, s));
        civilizationSpecialFlowery.forEach(s -> structuresByBiome.put(DefaultStructureBiomes.CIVILIZATION_SPECIAL_FLOWERY, s));
        specialIcy.forEach(s -> structuresByBiome.put(DefaultStructureBiomes.SPECIAL_ICY, s));
        specialMagical.forEach(s -> structuresByBiome.put(DefaultStructureBiomes.SPECIAL_MAGICAL, s));
        specialMediterranean.forEach(s -> structuresByBiome.put(DefaultStructureBiomes.SPECIAL_MEDITERRANEAN, s));
        specialMountainousCold.forEach(s -> structuresByBiome.put(DefaultStructureBiomes.SPECIAL_MOUNTAINOUS_COLD, s));
        specialMountainousHot.forEach(s -> structuresByBiome.put(DefaultStructureBiomes.SPECIAL_MOUNTAINOUS_HOT, s));
        specialRuined.forEach(s -> structuresByBiome.put(DefaultStructureBiomes.SPECIAL_RUINED, s));
        specialShroomy.forEach(s -> structuresByBiome.put(DefaultStructureBiomes.SPECIAL_SHROOMY, s));
        specialSpooky.forEach(s -> structuresByBiome.put(DefaultStructureBiomes.SPECIAL_SPOOKY, s));
        specialSwampy.forEach(s -> structuresByBiome.put(DefaultStructureBiomes.SPECIAL_SWAMPY, s));
        specialSwampyWarm.forEach(s -> structuresByBiome.put(DefaultStructureBiomes.SPECIAL_SWAMPY_WARM, s));
        oceanRareDeep.forEach(s -> structuresByBiome.put(DefaultStructureBiomes.OCEAN_RARE_DEEP, s));
        oceanRareShallow.forEach(s -> structuresByBiome.put(DefaultStructureBiomes.OCEAN_RARE_SHALLOW, s));
        oceanWarm.forEach(s -> structuresByBiome.put(DefaultStructureBiomes.OCEAN_WARM, s));
        oceanWarmDeep.forEach(s -> structuresByBiome.put(DefaultStructureBiomes.OCEAN_WARM_DEEP, s));
        oceanDeep.forEach(s -> structuresByBiome.put(DefaultStructureBiomes.OCEAN_DEEP, s));
        oceanShallow.forEach(s -> structuresByBiome.put(DefaultStructureBiomes.OCEAN_SHALLOW, s));
        oceanFrozen.forEach(s -> structuresByBiome.put(DefaultStructureBiomes.OCEAN_FROZEN, s));
        oceanDeepFrozen.forEach(s -> structuresByBiome.put(DefaultStructureBiomes.OCEAN_DEEP_FROZEN, s));
        oceanNotFrozen.forEach(s -> structuresByBiome.put(DefaultStructureBiomes.OCEAN_NOT_FROZEN, s));
        riverOrCoastNotFrozen.forEach(s -> structuresByBiome.put(DefaultStructureBiomes.RIVER_OR_COAST_NOT_FROZEN, s));
        riverOrCoastFrozen.forEach(s -> structuresByBiome.put(DefaultStructureBiomes.RIVER_OR_COAST_FROZEN, s));
        riverFrozen.forEach(s -> structuresByBiome.put(DefaultStructureBiomes.RIVER_FROZEN, s));
        riverNotFrozen.forEach(s -> structuresByBiome.put(DefaultStructureBiomes.RIVER_NOT_FROZEN, s));
        riverTemperate.forEach(s -> structuresByBiome.put(DefaultStructureBiomes.RIVER_TEMPERATE, s));
        riverWarm.forEach(s -> structuresByBiome.put(DefaultStructureBiomes.RIVER_WARM, s));
        undergroundLand.forEach(s -> structuresByBiome.put(DefaultStructureBiomes.ALL_UNDERGROUND_LAND, s));
    ...
    public static ArrayListMultimap<String, String> parseStructureRarities() {
        ...
        undergroundMassive.forEach(s -> structuresByRarity.put(DefaultStructureRarity.UNDERGROUND_MASSIVE, s));
    ...
    public static ArrayListMultimap<String, String> parseStructureFixes() {
        ...
        ignoreMod.forEach(s -> structuresByFix.put(Blacklist.IGNORE_MOD, s));
        ignoreStructure.forEach(s -> structuresByFix.put(Blacklist.IGNORE_STRUCTURE, s));
        ignoreStructureType.forEach(s -> structuresByFix.put(Blacklist.IGNORE_STRUCTURE_TYPE, s));
        ignoreBiomeRedistribution.forEach(s -> structuresByFix.put(Blacklist.IGNORE_BIOME_REDISTRIBUTION, s));
        ignoreFlatnessCheck.forEach(s -> structuresByFix.put(Blacklist.IGNORE_FLATNESS_CHECK, s));
